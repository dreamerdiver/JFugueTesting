...
public class HelloWorld {
    public static void main(String[] args){
        ...
        player.play(rhythm.getPattern().repeat(2), p1);
        player.play(rhythm.getPattern().repeat(2), p1, p2);
    }
}
...
Rain
player.play("T130 C5q D5q D#5q F5q | G5h D#5h | F5h D5h | C5w");
player.play("T130 C5q D5q D#5q F5q | G5h D#5h | F5h G#5h | G5h D#5h | C5w");
